...
let MODEL_INFO = {
  distilbert: { display: "DistilBERT", accuracy: 0.9107, macro_f1: 0.9111, available: false },
  roberta: { display: "RoBERTa", accuracy: 0.9175, macro_f1: 0.9177, available: false },
  electra: { display: "ELECTRA", accuracy: 0.8746, macro_f1: 0.8761, available: false },
  bert: { display: "BERT", accuracy: 0.8418, macro_f1: 0.8429, available: false },
};
let DEFAULT_MODEL = "roberta";
...
function renderSummary() {
  $("summary-text").innerHTML =
    "<strong>As shown in Table XXIII, RoBERTa has the highest overall performance " +
    "with 91.75% accuracy and 91.77% macro-F1, just ahead of DistilBERT " +
    "(91.07% accuracy, 91.11% macro-F1) by 0.68 percentage points in accuracy " +
    "and 0.66 in macro-F1. ELECTRA comes next at 87.46% accuracy, and the head-only " +
    "BERT is last at 84.18%. The difference between the best and worst models is about " +
    "7.5 macro-F1 points, showing that even with the same dataset, classification head, " +
    "and hyperparameters, the choice of backbone and fine-tuning depth makes a real difference " +
    "for Cambodian English news classification.</strong>";
}
